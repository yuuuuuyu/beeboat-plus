...
const base_application_1 = __importDefault(require("./base-application"));
class BTPApplication extends base_application_1.default {
    constructor(options) {
        super(options);
    ...
    mount() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            this.$app = (0, vue_1.createApp)(this.options.appTemplate);
...
exports.default = BTPApplication;
