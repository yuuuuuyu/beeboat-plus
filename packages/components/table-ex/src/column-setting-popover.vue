    ...
    <el-popover ref="popoverRef" trigger="hover" :width="370" @show="onPopoverShow">
        ...
        <template #default>
            <div class="bt-table-ex--setting">
                <el-input v-model="state.searchText" clearable placeholder="搜索显示字段" />
                ...
                <div class="bt-table-ex--setting-footer">
                    <bt-button type="info" @click="onColReset"> 取 消 </bt-button>
...
const getVerify = item => {
    return item.columnType == 3 && item.label?.indexOf(state.searchText || '') >= 0
}
