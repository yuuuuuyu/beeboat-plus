<!--
    1.此代码中的IntersectionObserver有浏览器兼容风险
    2.点击tab和IntersectionObserver会产生冲突，在某些情况下会导致tab也切换错误
    3.建议通过tabRef.value.querySelector('.el-tabs__content').addEventListener('scroll', () => {})的滚动事件来计算切换tab当前选中值
-->
<template>
