<template>
    ...
    >
        ...
        <template #footer>
            <bt-button type="info" @click="state.dialogVisible = false">取 消</bt-button>
            ...
            <bt-button @click="onSearchClick">查 询</bt-button>
        </template>
    </el-dialog>
    <el-dialog
    ...
    >
        ...
        <template #footer>
            <bt-button type="info" @click="state.dialogSaveVisible = false">取消</bt-button>
            <bt-button @click="onSaveAsDialogClick">确 定</bt-button>
        </template>
    </el-dialog>
</template>
